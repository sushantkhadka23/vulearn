...
export default function BrokenAuth() {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg font-lato text-gray-600">
            Dive deep into Brute Force attacks, explore how attackers exploit weak authentication mechanisms, and learn how to defend against them.
          </p>
        </div>
