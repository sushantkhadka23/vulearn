    ...
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 font-serif">
      <div className="max-w-md w-full space-y-8 bg-slate-800 p-10 rounded-2xl shadow-xl transition-all duration-300 hover:shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="space-y-4">
            <div className="relative">
              <FontAwesomeIcon icon={faEnvelope} className="absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-800" />
              <input
                name="email"
                type="email"
                required
            ...
            <div className="relative">
              <FontAwesomeIcon icon={faLock} className="absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-800" />
              <input
                name="password"
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/login/recovery" className="text-sm font-medium text-blue-300 hover:text-blue-500 transition duration-200">
              Forgot password?
            </Link>
          </div>
          <button
        ...
        <p className="mt-6 text-center text-sm text-gray-400">
          ...
          <Link to="/signup" className="font-medium text-blue-200 hover:text-blue-500 transition duration-200">
            Sign up
          </Link>
        </p>
      </div>
