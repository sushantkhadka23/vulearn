...
export default function Recovery() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-900 to-slate-900 flex items-center justify-center p-4 font-serif">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="container max-w-4xl bg-blue-900 rounded-lg shadow-lg overflow-hidden"
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 bg-blue-600 text-white p-8 flex items-center justify-center">
            <div className="max-w-md">
              ...
              <p className="text-lg">
                Enter your email address to receive recovery instructions. We'll
                guide you through the process of regaining access to your
                account.
              </p>
            </div>
          </div>
